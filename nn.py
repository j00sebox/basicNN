...
class NeuralNetwork(object):
    ...
    def __init__(self, inputNodes, hiddenNodes, outputNodes, outputLabels):
        ...
        self.weights_1 = np.random.uniform(-1.01, 1.01, size=(hiddenNodes, inputNodes))
        self.weights_2 = np.random.uniform(-1.01, 1.01, size=(outputNodes, hiddenNodes))
        
        # initialize random biases 
        self.bias_1 = np.random.uniform(-1.01, 1.01, size=(hiddenNodes, 1))
        self.bias_2 = np.random.uniform(-1.01, 1.01, size=(outputNodes, 1))
    ...
    def train(self, inputs, targets):
        ...
        gradient2 = self.lr*2*self.oActivation*(1 - self.oActivation)*error
        ...
        # calculate and add adjustments for the weights
        gradient1 = self.lr*2*self.hActivation*(1 - self.hActivation)*errorh
